...
## Запуск (v0.3.2 — M3 + детектор кадра IRQ)

**VirtualBox — самый простой путь:**
**[dist/aresos-vm-v0.3.2.zip](https://github.com/Poncho435/AresOS/raw/arena/01a02ad5-aresos/dist/aresos-vm-v0.3.2.zip)**
...
**[dist/aresos-usb-v0.3.2.zip](https://github.com/Poncho435/AresOS/raw/arena/01a02ad5-aresos/dist/aresos-usb-v0.3.2.zip)**
...
**[dist/aresos-iso-v0.3.2.zip](https://github.com/Poncho435/AresOS/raw/arena/01a02ad5-aresos/dist/aresos-iso-v0.3.2.zip)**
→ новая ВМ без жёсткого диска → прикрепить `aresos.iso` к CD-приводу → Запустить.

> v0.3.2 — этап M3 закрыт: собственные таблицы страниц (identity + HHDM,
